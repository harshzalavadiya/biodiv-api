...
public class SchedulerService {
	...
	public SchedulerStatus scheduleNow(String index, String type, User user, MapSearchQuery mapSearchQuery) {
		...
		jobDataMap.put(DownloadJob.SEARCH_KEY, mapSearchQuery);
