...
public class ObservationListController {
	...
	/**
	 * Call to update a particular document
	 * with given id and document
	 * @param index
	 * @param type
	 * @param documentId
	 * @param document
	...
	public MapBiodivResponse list(
			...
			@QueryParam("trait_8") String trait_8,
			@QueryParam("trait_9") String trait_9,
			@QueryParam("trait_10") String trait_10,
			@QueryParam("trait_11") String trait_11,
			@QueryParam("trait_12") String trait_12,
			@QueryParam("trait_13") String trait_13,
...
//		boolAndLists.add(new MapAndBoolQuery("datasetid", null));
		...
		/**
		 * Filter to implements the traits
		 * the traits filter is boolAndQuertype filters
		 */
