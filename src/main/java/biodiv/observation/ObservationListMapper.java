...
public class ObservationListMapper {
	...
	private String noofaudio;
	private String noofidentifications;
	private String name;
	private String taxonconceptid;
	private String acceptednameid;
	private String taxonomycanonicalform;
	private List<List<String>> traits;
	...
	public String getSpeciesgroupid() {
		return speciesgroupid;
	}
	public void setSpeciesgroupid(String speciesgroupid) {
	...
	public String getMaxvotedrecoid() {
		return maxvotedrecoid;
	}
	public void setMaxvotedrecoid(String maxvotedrecoid) {
	...
	public String getIsshowable() {
		return isshowable;
	}
	public void setIsshowable(String isshowable) {
	...
	public String getReprimageid() {
		return reprimageid;
	}
	public void setReprimageid(String reprimageid) {
	...
	public void setNoofaudio(String noofaudio) {
		this.noofaudio = noofaudio;
	}
	public String getNoofidentifications() {
		return noofidentifications;
	}
	public void setNoofidentifications(String noofidentifications) {
	...
	public String getAcceptednameid() {
		return acceptednameid;
	}
	public void setAcceptednameid(String acceptednameid) {
		this.acceptednameid = acceptednameid;
	}
	public String getTaxonomycanonicalform() {
		return taxonomycanonicalform;
	}
	public void setTaxonomycanonicalform(String taxonomycanonicalform) {
		this.taxonomycanonicalform = taxonomycanonicalform;
	}
	public List<List<String>> getTraits() {
		return traits;
	}
	public void setTraits(List<List<String>> traits) {
		this.traits = traits;
	}
